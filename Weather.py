...
def fetch_and_process_weather_data():
    ...
    latitude = 59.33  # Latitude for Stockholm, Sweden
    longitude = 18.07  # Longitude for Stockholm, Sweden
    ...
    try:
        ...
        # Data Transformation: Convert temperature from Celsius to Fahrenheit
        df['temperature_2m'] = df['temperature_2m'] * 9/5 + 32

        # Log transformed data types and initial rows
